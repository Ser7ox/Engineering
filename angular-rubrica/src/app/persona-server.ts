...
import { Persona } from './persona';
 ...
 export const Persone: Persona [] = [
    ...
    new Persona(2,'Francesca','Marini','F',3468433958,'Via Alatri 105, 00128, Roma'),
    ...
    new Persona(5,'Riccardo','Paoloni','M',3668971264,'Piazzale dell\'agricoltura 24, 00144, Roma'),
    new Persona(6,'Paola','Massetti','F',3478947126,'Via Libetta 12, 34697, Lecco')
 ];
